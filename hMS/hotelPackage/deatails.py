...
class DeatailsRoom:
    def __init__(self, root):
        self.root=root
        self.root.title("DeatailsRooms")
        self.root.geometry("1295x550+230+220")

  # ===================== Title ===================================#

        lbl_title = Label(self.root, text="Room Adding Depatment", font=("times new roman", 18, "bold"), bg="black",fg="gold", bd=4, relief=RIDGE)
        ...
        btnReset = Button(btn_frame, text="RESET",command=self.reset_data,font=("arial", 11, "bold"), bg="black",fg="Green", width=10)
