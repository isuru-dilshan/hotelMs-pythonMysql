...
class Register:
    def __init__(self,root):
        ...
        # ============================ bg image =================================
        self.bg = ImageTk.PhotoImage(file=r"C:\Users\Isuru Dilshan\Desktop\python\hotel MS\hMS\hotelPackage\image\reg1.jpg")
        lbl_bg = Label(self.root, image=self.bg)
        lbl_bg.place(x=0, y=0, relwidth=1, relheight=1)

        # ============================ left image ================================
        self.bg1 = ImageTk.PhotoImage(file=r"C:\Users\Isuru Dilshan\Desktop\python\hotel MS\hMS\hotelPackage\image\enjoy-the-little-things-470x550.jpg")
        ...
        security_Q=Label(frame, text="Select Security Quetions", font=("times new roman", 15, "bold"), fg="black", bg="white")
